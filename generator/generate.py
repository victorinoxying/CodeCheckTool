...
tag_dic = {'TAG.OTHER': 0, 'TAG.BODY': 1, 'TAG.SAFE': 2, 'TAG.UNSAFE': 3}
    ...
    def getData(self, fileName, num):
        ...
        for i in range(num):
            ...
            with open(codePath, 'w') as fileStream:
                ...
                tag_metadata['code_' + str(i) + '.c'] = self.getTag(line)
...
if __name__ == '__main__':
    args = _get_args()
    ge = Generator()
    ge.getData(args.outdir, int(args.num_instances))
    # ge.getData('../working/sa-test-10', 10)
    # for i in range(10):
    #     print(ge.nomal_stm())
